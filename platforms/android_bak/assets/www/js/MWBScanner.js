   		...
   		BarcodeScanner.MWBinitDecoder(function(){
            ...
            //BarcodeScanner.MWBsetZoomLevels(200, 400, 1);
              ...
              if (device.platform == "Android"){
                  ...
                  BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_EANUPC, "lars.goette@drive.eu", "58A33DC2736DDDBF3EA960446B811758BA7C24335A905BC0E6245554F076A346");
                  ...
                  if (device.platform == "iOS"){
                      ...
                      BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_AZTEC,  "username", "key");
                      BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_DM,     "username", "key");
                      BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_EANUPC, "lars.goette@drive.eu", "143747B589AAC8F2B83E41E8B300FC881266642071AB1693FED51ED9843AA494");
                      BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_PDF,    "username", "key");
                      BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_QR,     "username", "key");
                      BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_RSS,    "username", "key");
                      BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_CODABAR,"username", "key");
                      ...
                      if (device.platform == "Win32NT") {
                          ...
                          BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_AZTEC,  "username", "key");
                          BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_DM,     "username", "key");
                          BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_EANUPC, "lars.goette@drive.eu", "7A59CC8A9F8CDDEDAF0D104E1762DEAE5EA75DB55628C5A5516785500B33CECE");
                          BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_PDF,    "username", "key");
                          BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_QR,     "username", "key");
                          BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_RSS,    "username", "key");
                          BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_CODABAR,"username", "key");
            ...
            BarcodeScanner.MWBstartScanning(function(result)
            {
                ...
                if (result && result.code){
                    $("#mybattery").html("Daten werden aktualisiert ...");
                    var jqxhr = $.get( "http://www.powerone-batteries.com/index.php?id=287&barcodetype="+result.type+"&barcode="+result.code+"&type=5000", function(data) {

                        try {
                            var json = jQuery.parseJSON(data);
                            var battery = json.batteries;
                            if (battery) {
                                $("#mybattery").html(battery[0]["name"]);
                                window.localStorage.setItem("mybattery", battery[0]["name"]);
                            }
                        }
                        catch(err) {
                            $("#mybattery").html("Batterie nicht vorhanden!");
                        }
                    ...
                    //navigator.notification.alert("Ihre Batterie wurde erkannt!", function(){}, "Ihre Batterie", 'ok');
